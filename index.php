	...
	<div class="header">
		...
		<div id="mycarousel" class="carousel slide" data-ride="carousel">
		  <div class="carousel-inner">
			      ...
			      <img class="d-block w-100" src="images/slider/banner.jpg" alt="First slide">
			       <div class="carousel-caption d-md-block">
				    <h2 class="wow flash">SA Management Consultancy Firm</h2>
				    <p class="mt-2 wow bounce">A Reliable Valley of Income Tax, VAT, Business Support
						System, Accounts and Corporate Affairs.</p>
			    ...
			    <div class="carousel-item">
			      <img class="d-block w-100" src="images/slider/financial.jpg" alt="First slide">
			       <div class="carousel-caption d-md-block">
				    <h2 class="">Accounting and Financial Reporting Services</h2>
				    <p></p>
				    <a href="#call-back" class="btn btn-info py-2">Request Callback</a>
				  </div>
				  <div class="overlay1"></div>
		...
		<div class="box owl-carousel owl-theme">
			<div class="s1">
				...
				<div class="stext mt-2">
					...
					<hr>
					<p class="lead mt-2">To help our clients keep pace with competitive<a href="accounting.html">click here</a></p>
				</div>
			</div>
			<div class="s1">
				<div class="img">
				...
				<div class="stext mt-2">
					...
					<hr>
					<p class="lead mt-2">SAMC offers clients a broad range of fully integrated income tax services <br><a href="income-tax.html">click here</a> for more details</p>
				</div>
			</div>
			<div class="s1">
				<div class="img">
				...
				<div class="stext mt-2">
					...
					<hr>
					<p class="lead mt-2">To meet our objective SAMC oﬀers its clients a broad range of fully integrated tax services<br><a href="corporate-tax.html">click here</a> for more details</p>
				</div>
			</div>
			<div class="s1">
				<div class="img">
				...
				<div class="stext mt-2">
					...
					<hr>
					<p class="lead mt-2">Tax Health checkup, Tax Retainer Services, TIN registration<a href="advisor-tax.html"><br>click here</a> for more details</p>
				</div>
			</div>
			<div class="s1">
				<div class="img">
				...
				<div class="stext mt-2">
					...
					<hr>
					<p class="lead mt-2">Local government is more concern to increase revenue through collecting indirect tax <br><a href="vat.html">click here</a> for more details</p>
				</div>
			</div>
			<div class="s1">
				<div class="img">
				...
				<div class="stext mt-2">
					...
					<hr>
					<p class="lead mt-2">Registrar of Joint Stock Companies (RJSC)<br><a href="bida.html">click here</a> for more details</p>
				</div>
			</div>
			<div class="s1">
				<div class="img">
				...
				<div class="stext mt-2">
					...
					<hr>
					<p class="lead mt-2">>Business Process Outsourcing (BPO) <br><a href="bpo.html">click here</a> for more details</p>
				</div>
			</div>
			<div class="s1">
				<div class="img">
				...
				<div class="stext mt-2">
					...
					<hr>
					<p class="lead mt-2">With a sharp focus to simplify the complexity of today’s business environment<br><a href="consultancy.html">click here</a> for more details</p>
				</div>
			</div>
	...
	<div class="box2 p-5">
		<div class="row">
			...
			<div class="col-lg-2 col-sm-12 mt-5">
				<a href="" class="btn btn-info">GET ADVICE&nbsp;&nbsp;<i class="fa fa-chevron-right"></i></a>
			</div>				
		</div>	
	</div>
</div>
